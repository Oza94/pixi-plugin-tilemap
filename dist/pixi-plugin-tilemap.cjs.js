...
var TilemapShader = /** @class */ (function (_super) {
    ...
    function TilemapShader() {
        var _this = _super.call(this, new pixi_js.Program(vertex, fragment, "tilemap")) || this;
...
var TilemapRenderer = /** @class */ (function (_super) {
    ...
    function TilemapRenderer(renderer) {
        ...
        _this._matrix = new pixi_js.Matrix();
        _this.quad = new pixi_js.QuadUv();
...
var TileGeometry = /** @class */ (function (_super) {
    ...
    function TileGeometry() {
        ...
        _this.buffer = new pixi_js.Buffer(new Float32Array(2), true, false);
        // Vertex position
        ...
        _this.indexBuffer = new pixi_js.Buffer(undefined, true, true);
